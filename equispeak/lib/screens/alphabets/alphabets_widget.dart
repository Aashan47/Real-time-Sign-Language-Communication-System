...
import 'alphabets_model.dart';
export 'alphabets_model.dart';
...
class AlphabetsWidget extends StatefulWidget {
  const AlphabetsWidget({super.key});

  @override
  State<AlphabetsWidget> createState() => _AlphabetsWidgetState();
}
...
class _AlphabetsWidgetState extends State<AlphabetsWidget> {
  late AlphabetsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AlphabetsModel());
  }
                        ...
                        Padding(
                          ...
                          child: FlipCard(
                            ...
                            back: ClipRRect(
                              ...
                              // ),
                              child: Image.asset(
                                'assets/images/image_1.png', // Correct the path to your local asset
                                width: 150.0,
                                height: 200.0,
                                fit: BoxFit.cover,
                              ),
